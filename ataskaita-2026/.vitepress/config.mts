...
export default defineConfig({
  srcDir: './src',
  sitemap: {
    hostname: 'https://ataskaita2026.vusa.lt',
  },
  head: [
    // Font preloads
    [
    ...
    ['meta', { property: 'og:url', content: 'https://ataskaita2026.vusa.lt' }],
    ['meta', { property: 'og:image', content: '/img/meta.png' }],
    ['meta', { property: 'og:image:alt', content: 'VU SA metinė ataskaita 2026' }],
    ['meta', { property: 'og:site_name', content: 'VU SA metinė ataskaita 2025-2026' }],
    // Twitter
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: '/img/meta.png' }],
    ['meta', { name: 'twitter:image:alt', content: 'VU SA metinė ataskaita 2026' }],
    // Canonical URL
