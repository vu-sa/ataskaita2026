...
2025–2026 m. ISF ne tik rūpinosi paraiškų vertinimu ir sprendimų priėmimu dėl kompetencijų kėlimo veiklų finansavimo, bet ir įgyvendino strategines iniciatyvas. Fondo posėdžiuose buvo aptartas ir koordinuotas patirties perdavimo procesas, refleksijų kultūros plėtra bei bendruomenės tyrimo įgyvendinimas, organizuoti mokymai.

Taip pat fondas buvo atsakingas už VU SA stiprios organizacijos strateginį tikslą, kuris siekia efektyvinti studentų (-čių) atstov(i)ų veiklą, įgyvendinti šiame tiksle numatyti veiksmai. Atnaujinome lektorių duomenų bazę, plėtojome mentorystės programą organizacijos vadovams (-ėms), peržiūrėjome ir atnaujinome VU SA mokymų tinklelį. Vykdyti reguliarūs susitikimai su žmogiškųjų išteklių koordinatoriais (-ėmis), kuriuose aptarti aktualūs organizacijos narių pritraukimo, mokymų planavimo ir narių įveiklinimo klausimai.
