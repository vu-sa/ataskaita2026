...
- Taip pat parengtas studentų (-čių) atstovų (-ių) naudų paketas, kuris bus viešinamas vusa.lt svetainėje.
...
- Kartu su VU Bendruomenės gerovės skyriumi balandžio mėn. buvo organizuoti mokymai skirtingomis temomis apie psichologinį atsparumą. Sutarta panašią mokymų programą tęsti ir kitais metais.
...
- Kartu su VU SA Studentų pilietinio pasipriešinimo komitetu parengtas dokumentas apie didesnį pilietinio pasipriešinimo kompetencijų įtraukimą į studijų procesą. Šis dokumentas buvo integruotas į VU SA dokumentą dėl saugumo spragų vertinimo ir rekomendacijų.
...
- Siekiant plėtoti VU studentų (-čių) žinias apie darnumą, VU SA savo iniciatyva skelbė įvairius įrašus darnumo tematika.
